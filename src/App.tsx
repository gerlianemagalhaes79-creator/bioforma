...
export default function App() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'diet': return <DietSection user={user} profile={userProfile} onNavigateTab={setActiveTab} />;
      case 'nutritionist': return <NutritionistSection user={user} profile={userProfile} onNavigateTab={setActiveTab} />;
